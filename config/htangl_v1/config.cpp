...
size_t game_mode_configs_count = sizeof(game_mode_configs) / sizeof(GameModeConfig);
...
size_t keyboard_modes_count = sizeof(keyboard_modes) / sizeof(KeyboardModeConfig);
...
size_t backend_configs_count = sizeof(backend_configs) / sizeof(CommunicationBackendConfig);
*/
