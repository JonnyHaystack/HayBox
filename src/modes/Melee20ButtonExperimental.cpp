...
Melee20ButtonExperimental::Melee20ButtonExperimental(socd::SocdType socd_type) : ControllerMode(socd_type) {
    _socd_pair_count = 4;
...
void Melee20ButtonExperimental::HandleSocd(InputState &inputs) {
    horizontal_socd = inputs.left && inputs.right;
    InputMode::HandleSocd(inputs);
}

void Melee20ButtonExperimental::UpdateDigitalOutputs(InputState &inputs, OutputState &outputs) {
    outputs.a = inputs.a;
    outputs.b = inputs.r;
    outputs.x = inputs.x;
    outputs.y = inputs.y;
    ...
    // if ((inputs.mod_x && inputs.mod_y) || inputs.midshield) {
...
void Melee20ButtonExperimental::UpdateAnalogOutputs(InputState &inputs, OutputState &outputs) {
